...
//import com.github.arhor.linden.dragon.tavern.data.persistence.repository.BaseRepository
...
//    }
//
//    @Pointcut("execution(* com.github.arhor.linden.dragon.tavern.data.persistence.repository.BaseRepository+.save*(..))")
//    fun saveEvent() { /* no-op */
//    }
//
//    @Pointcut("execution(* com.github.arhor.linden.dragon.tavern.data.persistence.repository.BaseRepository+.delete*(..))")
